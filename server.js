...
app.post("/chat", async (req, res) => {
  try {
    ...
    // =====================================================
    // 🖼️ RUNWAY TEXT TO IMAGE
    // =====================================================
    if (message.toLowerCase().includes("runway billede")) {
      ...
      reply = "🎨 Runway genereret billede:";
    }
    ...
    // =====================================================
      ...
      if (data.id) {
        ...
        if (videoUrl) reply = "🎬 Her er din video:";
        if (!videoUrl && reply === "")
